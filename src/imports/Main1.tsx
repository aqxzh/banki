import svgPaths from "./svg-owukadl8i2";
...
function Container13() {
  return (
    <div className="bg-[#dbeafe] h-[64px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
function Heading() {
  return (
    <div className="absolute h-[32px] left-0 top-0 w-[502px]" data-name="Heading 2">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-0 not-italic text-[#1e293b] text-[24px] top-0 tracking-[0.0703px]">Абдуллаева Айгерим Ержановна</p>
    </div>
  );
}
...
function Paragraph20() {
  return (
    <div className="absolute h-[24px] left-0 top-[36px] w-[502px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Главный специалист отдела бюджетного планирования</p>
    </div>
  );
}
...
function Badge10() {
  return (
    <div className="bg-[#2563eb] h-[26px] relative rounded-[8px] shrink-0 w-[111.695px]" data-name="Badge">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center overflow-clip px-[13px] py-[5px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[12px] text-white">Категория C-1</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Text11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[120.945px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px] w-[121px] whitespace-pre-wrap">ID: EMP-2024-001</p>
      </div>
    </div>
  );
}
...
function Container57() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[26px] items-center left-0 top-[72px] w-[502px]" data-name="Container">
      <Badge10 />
      <Text11 />
    </div>
  );
...
function Icon23() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M5.33333 1.33333V4" id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M10.6667 1.33333V4" id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p3ee34580} id="Vector_3" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M2 6.66667H14" id="Vector_4" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Text12() {
  return (
    <div className="h-[20px] relative shrink-0 w-[59.234px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Возраст:</p>
      </div>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="h-[20px] relative shrink-0 w-[43.5px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[-0.23px] not-italic text-[#1e293b] text-[14px] top-px tracking-[-0.1504px] w-[51px] whitespace-pre-wrap">38 лет</p>
      </div>
    </div>
  );
}
...
function Icon24() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_33_3802)" id="Icon">
          <path d="M8 4V8L10.6667 9.33333" id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p39ee6532} id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
...
function Text14() {
  return (
    <div className="h-[20px] relative shrink-0 w-[39.094px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Стаж:</p>
      </div>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="h-[20px] relative shrink-0 w-[41.188px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[-0.09px] not-italic text-[#1e293b] text-[14px] top-px tracking-[-0.1504px] w-[48px] whitespace-pre-wrap">16 лет</p>
      </div>
    </div>
  );
}
...
function Text16() {
  return (
    <div className="h-[20px] relative shrink-0 w-[116.102px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Национальность:</p>
      </div>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="h-[20px] relative shrink-0 w-[37.234px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#1e293b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Казах</p>
      </div>
    </div>
  );
}
...
function Icon26() {
  return (
    <div className="relative shrink-0 size-[9.484px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.48438 9.48438">
        <g clipPath="url(#clip0_33_3791)" id="Icon">
          <path d={svgPaths.p1d237080} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.790365" />
          <path d={svgPaths.p1b5fc000} id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.790365" />
        </g>
        <defs>
...
function Text18() {
  return (
    <div className="h-[20px] relative shrink-0 w-[45.398px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Орган:</p>
      </div>
    </div>
  );
}
...
function Text19() {
  return (
    <div className="flex-[1_0_0] h-[32px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#1e293b] text-[12px] top-px w-[147px] whitespace-pre-wrap">Министерство финансов Республики Казахстан</p>
      </div>
    </div>
  );
}
...
function Container58() {
  return (
    <div className="absolute gap-x-[24px] gap-y-[8px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[__20px_minmax(0,1fr)] h-[60px] left-0 top-[114px] w-[502px]" data-name="Container">
      <Container59 />
      <Container60 />
      <Container61 />
      <Container62 />
...
function Container56() {
  return (
    <div className="absolute h-[174px] left-[120px] top-0 w-[502px]" data-name="Container">
      <Heading />
      <Paragraph20 />
      <Container57 />
      <Container58 />
...
function Text20() {
  return (
    <div className="bg-gradient-to-b flex-[1_0_0] from-[#2563eb] h-[92px] min-h-px min-w-px relative rounded-[16777200px] to-[#1e40af]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[32px] not-italic relative shrink-0 text-[24px] text-white tracking-[0.0703px]">АА</p>
      </div>
    </div>
  );
}
...
function PrimitiveSpan() {
  return (
    <div className="absolute left-0 rounded-[16777200px] size-[96px] top-0" data-name="Primitive.span">
...
function Container54() {
  return (
    <div className="bg-white h-[239px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-b border-solid inset-0 pointer-events-none" />
...
function Icon27() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.pe6b10c0} id="Vector" stroke="var(--stroke-0, #2563EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p4c21d00} id="Vector_2" stroke="var(--stroke-0, #2563EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading1() {
  return (
    <div className="h-[28px] relative shrink-0 w-[111.172px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#1e293b] text-[18px] top-0 tracking-[-0.4395px]">Опыт работы</p>
      </div>
    </div>
  );
}
...
function Container64() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[40px] items-center left-0 top-0 w-[622px]" data-name="Container">
      <Container65 />
      <Heading1 />
    </div>
  );
...
function Container68() {
  return (
    <div className="absolute h-[20px] left-0 top-0 w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">2018 — настоящее время • 6 лет</p>
    </div>
  );
}
...
function Container69() {
  return (
    <div className="absolute h-[24px] left-0 top-[24px] w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#1e293b] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Главный специалист отдела бюджетного планирования</p>
    </div>
  );
}
...
function Container70() {
  return (
    <div className="absolute h-[20px] left-0 top-[52px] w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Министерство финансов Республики Казахстан</p>
    </div>
  );
}
...
function Container71() {
  return (
    <div className="absolute h-[20px] left-0 top-[80px] w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">12 лет в сфере государственных финансов и бюджетирования</p>
    </div>
  );
}

function Container72() {
  return <div className="absolute bg-[#2563eb] border-2 border-solid border-white left-[-18px] rounded-[16777200px] size-[12px] top-[4px]" data-name="Container" />;
}
...
function Container74() {
  return (
    <div className="absolute h-[20px] left-0 top-0 w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">2015 — 2018 • 3 года</p>
    </div>
  );
}
...
function Container75() {
  return (
    <div className="absolute h-[24px] left-0 top-[24px] w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#1e293b] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Специалист отдела анализа</p>
    </div>
  );
}
...
function Container76() {
  return (
    <div className="absolute h-[20px] left-0 top-[52px] w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Департамент финансов</p>
    </div>
  );
}

function Container77() {
  return <div className="absolute bg-[#e2e8f0] border-2 border-solid border-white left-[-18px] rounded-[16777200px] size-[12px] top-[4px]" data-name="Container" />;
}
...
function Container79() {
  return (
    <div className="absolute h-[20px] left-0 top-0 w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">2012 — 2015 • 3 года</p>
    </div>
  );
}
...
function Container80() {
  return (
    <div className="absolute h-[24px] left-0 top-[24px] w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#1e293b] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Младший специалист</p>
    </div>
  );
}
...
function Container81() {
  return (
    <div className="absolute h-[20px] left-0 top-[52px] w-[576px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Министерство экономики</p>
    </div>
  );
}
...
function Container66() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[284px] items-start left-[20px] pl-[26px] top-[56px] w-[602px]" data-name="Container">
...
function Section() {
  return (
    <div className="h-[340px] relative shrink-0 w-full" data-name="Section">
      <Container64 />
      <Container66 />
    </div>
  );
...
function PrimitiveDiv() {
  return <div className="bg-[#e2e8f0] h-px shrink-0 w-full" data-name="Primitive.div" />;
}
...
function Icon28() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.pff1d700} id="Vector" stroke="var(--stroke-0, #10B981)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M18.3333 8.33333V13.3333" id="Vector_2" stroke="var(--stroke-0, #10B981)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1ead9c00} id="Vector_3" stroke="var(--stroke-0, #10B981)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading2() {
  return (
    <div className="h-[28px] relative shrink-0 w-[113.164px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#1e293b] text-[18px] top-0 tracking-[-0.4395px]">Образование</p>
      </div>
    </div>
  );
}
...
function Container86() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#1e293b] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Высшее экономическое, КазНУ им. Аль-Фараби, Экономика</p>
    </div>
  );
}
...
function Container87() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Государственный диплом</p>
    </div>
  );
}
...
function Container85() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col gap-[8px] h-[86px] items-start left-[44px] pb-px pt-[17px] px-[17px] rounded-[14px] top-[56px] w-[578px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <Container86 />
      <Container87 />
    </div>
...
function Section1() {
  return (
    <div className="h-[142px] relative shrink-0 w-full" data-name="Section">
      <Container83 />
      <Container85 />
    </div>
  );
...
function Icon29() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p3ac0b600} id="Vector" stroke="var(--stroke-0, #F59E0B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3c797180} id="Vector_2" stroke="var(--stroke-0, #F59E0B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading3() {
  return (
    <div className="h-[28px] relative shrink-0 w-[234.586px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#1e293b] text-[18px] top-0 tracking-[-0.4395px]">Профессиональные навыки</p>
      </div>
    </div>
  );
}
...
function Badge11() {
  return (
    <div className="absolute bg-white h-[22px] left-0 rounded-[8px] top-0 w-[140.422px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1e293b] text-[12px]">Финансовый анализ</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Badge12() {
  return (
    <div className="absolute bg-white h-[22px] left-[148.42px] rounded-[8px] top-0 w-[177.117px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1e293b] text-[12px]">Бюджетное планирование</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Badge13() {
  return (
    <div className="absolute bg-white h-[22px] left-[333.54px] rounded-[8px] top-0 w-[224.172px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1e293b] text-[12px]">Экономическое прогнозирование</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Badge14() {
  return (
    <div className="absolute bg-white h-[22px] left-0 rounded-[8px] top-[30px] w-[163.68px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1e293b] text-[12px]">MS Excel (продвинутый)</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Badge15() {
  return (
    <div className="absolute bg-white h-[22px] left-[171.68px] rounded-[8px] top-[30px] w-[114.836px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1e293b] text-[12px]">1С: Бухгалтерия</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Badge16() {
  return (
    <div className="absolute bg-white h-[22px] left-[294.52px] rounded-[8px] top-[30px] w-[68.211px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1e293b] text-[12px]">SAP ERP</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Badge17() {
  return (
    <div className="absolute bg-white h-[22px] left-[370.73px] rounded-[8px] top-[30px] w-[138.453px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1e293b] text-[12px]">Казахский (родной)</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Badge18() {
  return (
    <div className="absolute bg-white h-[22px] left-0 rounded-[8px] top-[60px] w-[138.711px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1e293b] text-[12px]">Русский (свободно)</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Badge19() {
  return (
    <div className="absolute bg-white h-[22px] left-[146.71px] rounded-[8px] top-[60px] w-[117.82px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1e293b] text-[12px]">Английский (B2)</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container90() {
  return (
    <div className="absolute h-[82px] left-[44px] top-[56px] w-[578px]" data-name="Container">
      <Badge11 />
      <Badge12 />
      <Badge13 />
      <Badge14 />
...
function Section2() {
  return (
    <div className="h-[138px] relative shrink-0 w-full" data-name="Section">
      <Container88 />
      <Container90 />
    </div>
  );
...
function Icon30() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p27e2e0c0} id="Vector" stroke="var(--stroke-0, #EF4444)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p809b580} id="Vector_2" stroke="var(--stroke-0, #EF4444)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container92() {
  return (
    <div className="bg-[#fee2e2] relative rounded-[10px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon30 />
      </div>
    </div>
...
function Heading4() {
  return (
    <div className="h-[28px] relative shrink-0 w-[195.914px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#1e293b] text-[18px] top-0 tracking-[-0.4395px]">Награды и достижения</p>
      </div>
    </div>
  );
}
...
function Icon31() {
  return (
    <div className="absolute left-0 size-[20px] top-[2px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p5cb4500} id="Vector" stroke="var(--stroke-0, #F59E0B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container96() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#1e293b] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Благодарность Министерства Финансов РК</p>
    </div>
  );
}
...
function Container97() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">2022 год</p>
    </div>
  );
}
...
function Container95() {
  return (
    <div className="absolute content-stretch flex flex-col h-[44px] items-start left-[32px] top-0 w-[332.383px]" data-name="Container">
      <Container96 />
      <Container97 />
    </div>
  );
...
function Container100() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#1e293b] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Лучший специалист отдела</p>
    </div>
  );
}
...
function Container101() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">2020 год</p>
    </div>
  );
}
...
function Container99() {
  return (
    <div className="absolute content-stretch flex flex-col h-[44px] items-start left-[32px] top-0 w-[209.117px]" data-name="Container">
      <Container100 />
      <Container101 />
    </div>
  );
...
function Container104() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#1e293b] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Участие в международных конференциях</p>
    </div>
  );
}
...
function Container105() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">2019, 2021, 2023</p>
    </div>
  );
}
...
function Container103() {
  return (
    <div className="absolute content-stretch flex flex-col h-[44px] items-start left-[32px] top-0 w-[318.078px]" data-name="Container">
      <Container104 />
      <Container105 />
    </div>
  );
...
function Container93() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[156px] items-start left-[20px] pl-[24px] top-[56px] w-[602px]" data-name="Container">
      <Container94 />
      <Container98 />
      <Container102 />
    </div>
...
function Section3() {
  return (
    <div className="h-[212px] relative shrink-0 w-full" data-name="Section">
      <Container91 />
      <Container93 />
    </div>
  );
...
function Heading5() {
  return (
    <div className="h-[28px] relative shrink-0 w-[227.617px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#1e293b] text-[18px] top-0 tracking-[-0.4395px]">Дополнительные сведения</p>
      </div>
    </div>
  );
}
...
function Container110() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Реализованных проектов</p>
    </div>
  );
}
...
function Container111() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-0 not-italic text-[#2563eb] text-[24px] top-0 tracking-[0.0703px]">12+</p>
    </div>
  );
}
...
function Container113() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#64748b] text-[14px] top-[0.5px] tracking-[-0.1504px]">Должностей в карьере</p>
    </div>
  );
}
...
function Container114() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-0 not-italic text-[#10b981] text-[24px] top-0 tracking-[0.0703px]">3</p>
    </div>
  );
}
...
function Container108() {
  return (
    <div className="absolute gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] h-[90px] left-[44px] top-[56px] w-[578px]" data-name="Container">
      <Container109 />
      <Container112 />
    </div>
  );
...
function Section4() {
  return (
    <div className="h-[146px] relative shrink-0 w-full" data-name="Section">
      <Container106 />
      <Container108 />
    </div>
  );
...
function Container63() {
  return (
    <div className="h-[1286px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[32px] items-start pt-[24px] px-[32px] relative size-full">
        <Section />
        <PrimitiveDiv />
        <Section1 />
        <PrimitiveDiv1 />
...
function Container53() {
  return (
    <div className="absolute content-stretch flex flex-col h-[641px] items-start left-px overflow-x-clip overflow-y-auto top-0 w-[686px]" data-name="Container">
      <Container54 />
      <Container63 />
    </div>
  );
      ...
      <div className="absolute inset-1/4" data-name="Vector">
        <div className="absolute inset-[-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.6667 11.6667">
            <path d={svgPaths.p354ab980} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-1/4" data-name="Vector">
        <div className="absolute inset-[-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.6667 11.6667">
            <path d={svgPaths.p2a4db200} id="Vector" stroke="var(--stroke-0, #64748B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
    </div>
...
function Button() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[643px] size-[20px] top-[24px]" data-name="Button">
      <Icon35 />
    </div>
  );
}
...
function EmployeeDetailsPanel() {
  return (
    <div className="bg-white h-[641px] relative shrink-0 w-[687px]" data-name="EmployeeDetailsPanel">
...
export default function Main() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="main1">
      <Container />
      <Container3 />
    </div>
  );
